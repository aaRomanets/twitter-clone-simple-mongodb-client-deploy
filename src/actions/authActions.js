...
export const loginUser = (userData)  => dispatch => 
{
    ...
    axios.post('https://twitter-clone-simple-server.herokuapp.com/api/users/login',userData).then(res => 
    {
...
export const registerUser = (userData,history) => dispatch => 
{
    ...
    axios.post('https://twitter-clone-simple-server.herokuapp.com/api/users/register',userData)
...
export const getCurrentUser = () => dispatch => 
{
    ...
    axios.get('https://twitter-clone-simple-server.herokuapp.com/api/users').then(res => dispatch(setCurrentUser(res.data)))
}
