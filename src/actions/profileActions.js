...
export const getUserProfile = (userId) => dispatch => 
{
    ...
    axios.get(`https://twitter-clone-simple-server.herokuapp.com/api/users/${userId}`).then(res => dispatch(
    {
        type: GET_PROFILE,
...
export const getPostsByUserId = (userId) => dispatch => 
{
    ...
    axios.get(`https://twitter-clone-simple-server.herokuapp.com/api/posts/${userId}`).then(res => dispatch(
    {
        type: GET_POSTS,
...
export const followUser = (userId) => dispatch => 
{
    ...
    axios.post('https://twitter-clone-simple-server.herokuapp.com/api/users/follow', {userId}).then(res => 
...
export const unfollowUser = (userId) => dispatch => 
{
    ...
    axios.post('https://twitter-clone-simple-server.herokuapp.com/api/users/unfollow', {userId}).then(res => 
    //процесс прошел успешно
    dispatch(
    {
        type: UNFOLLOW,
...
export const searchUser = (searchData, history) => dispatch => 
{
    ...
    axios.post('https://twitter-clone-simple-server.herokuapp.com/api/users/search', searchData).then(res => 
    {
