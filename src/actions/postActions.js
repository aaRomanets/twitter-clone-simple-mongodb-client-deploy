...
export const addPost = postData => dispatch => 
{
    ...
    axios.post('https://twitter-clone-simple-server.herokuapp.com/api/posts/add', postData).then(res => dispatch(
    {
        type: ADD_POST,
...
export const getPosts = () => dispatch => 
{
    ...
    axios.get('https://twitter-clone-simple-server.herokuapp.com/api/posts').then(res => dispatch(
    {
        type: GET_POSTS,
...
export const getPostsByFolowingUsers = () => dispatch => 
{
    //запускаем сигнализатор загрузки указанных постов с сервера
    dispatch(loadPosts)
    axios.get('https://twitter-clone-simple-server.herokuapp.com/api/posts/following').then(res => dispatch(
    {
        type: GET_POSTS,
